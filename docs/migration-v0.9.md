...
- CAPMOX v0.8.x — direct upgrade from earlier releases is not supported
- Cluster API and clusterctl v1.12
- IPAM provider in-cluster v1.1.0 if using IP address management

## Upgrading from previous versions

If you are upgrading from v0.7 or lower (v1alpha1 / CAPI v1beta1), follow the
[v0.7 → v0.8 migration guide](migration-v0.8-v1alpha2.md) first.

>[!WARNING]
>You must upgrade to the latest release of CAPMOX **v0.8** before proceeding
>with the v0.9 upgrade.
>Upgrading to **v0.9** from **pre-v0.8** releases is *not supported*.
