...
## CAPMOX on Google Code Wiki

Gemini's autogenerated documentation of CAPMOX. It's quite thorough.

[ionos-cloud/cluster-api-provider-proxmox | Code Wiki](https://codewiki.google/github.com/ionos-cloud/cluster-api-provider-proxmox)
