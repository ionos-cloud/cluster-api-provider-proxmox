...
// FindVMTemplatesByTags provides a mock function with given fields: ctx, templateTags, allowedNodes, localStorage, matchPolicy
func (_m *MockClient) FindVMTemplatesByTags(ctx context.Context, templateTags []string, allowedNodes []string, localStorage bool, matchPolicy string) (map[string]int32, error) {
	ret := _m.Called(ctx, templateTags, allowedNodes, localStorage, matchPolicy)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, []string, bool, string) (map[string]int32, error)); ok {
		return rf(ctx, templateTags, allowedNodes, localStorage, matchPolicy)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, []string, bool, string) map[string]int32); ok {
		r0 = rf(ctx, templateTags, allowedNodes, localStorage, matchPolicy)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, []string, bool, string) error); ok {
		r1 = rf(ctx, templateTags, allowedNodes, localStorage, matchPolicy)
	} else {
		r1 = ret.Error(1)
	}
...
//   - localStorage bool
//   - matchPolicy string
func (_e *MockClient_Expecter) FindVMTemplatesByTags(ctx interface{}, templateTags interface{}, allowedNodes interface{}, localStorage interface{}, matchPolicy interface{}) *MockClient_FindVMTemplatesByTags_Call {
	return &MockClient_FindVMTemplatesByTags_Call{Call: _e.mock.On("FindVMTemplatesByTags", ctx, templateTags, allowedNodes, localStorage, matchPolicy)}
}

func (_c *MockClient_FindVMTemplatesByTags_Call) Run(run func(ctx context.Context, templateTags []string, allowedNodes []string, localStorage bool, matchPolicy string)) *MockClient_FindVMTemplatesByTags_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_FindVMTemplatesByTags_Call) RunAndReturn(run func(context.Context, []string, []string, bool, string) (map[string]int32, error)) *MockClient_FindVMTemplatesByTags_Call {
	_c.Call.Return(run)
	return _c
}
