...
func (_m *MockClient) EnsureHAResource(ctx context.Context, vmID int64, state v1alpha2.HighAvailabilityState) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, v1alpha2.HighAvailabilityState) error); ok {
...
//   - ctx context.Context
//   - vmID int64
//   - state v1alpha2.HighAvailabilityState
...
func (_c *MockClient_EnsureHAResource_Call) Run(run func(ctx context.Context, vmID int64, state v1alpha2.HighAvailabilityState)) *MockClient_EnsureHAResource_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64), args[2].(v1alpha2.HighAvailabilityState))
	})
	return _c
}
...
func (_c *MockClient_EnsureHAResource_Call) RunAndReturn(run func(context.Context, int64, v1alpha2.HighAvailabilityState) error) *MockClient_EnsureHAResource_Call {
	_c.Call.Return(run)
	return _c
}
