				...
				nics: []types.NetworkConfigData{
					{
						...
						IPConfigs: []types.IPConfig{
							{IPAddress: netip.MustParsePrefix("10.0.0.98/25"), Gateway: "10.0.0.1", Metric: new(int32(100))},
							{IPAddress: netip.MustParsePrefix("2001:db8:1::10/64"), Gateway: "2001:db8:1::1", Metric: new(int32(100))},
						},
					...
					},
					{
						...
						MacAddress: "E2:8E:95:1F:EB:36",
						IPConfigs: []types.IPConfig{
							{IPAddress: netip.MustParsePrefix("10.0.1.84/25"), Gateway: "10.0.1.1", Metric: new(int32(200))},
						},
						ProxName:   "net1",
						DNSServers: []string{"10.0.1.1"},
