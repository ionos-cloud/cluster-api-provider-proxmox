...
func (n *Network) Validate() error {
	...
	// Devices are intentionally not required to carry an IP address. IPAM-managed
	// addresses are guaranteed upstream in bootstrap.go, and a device without any
	// IPAM address could be a bridge member.
	for i := range n.Devices {
		d := &n.Devices[i]
