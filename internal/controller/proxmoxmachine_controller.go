...
func (r *ProxmoxMachineReconciler) getInfraCluster(ctx context.Context, logger *logr.Logger, cluster *clusterv1.Cluster, proxmosMachine *infrav1.ProxmoxMachine) (*scope.ClusterScope, error) {
