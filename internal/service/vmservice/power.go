...
func reconcilePowerState(ctx context.Context, machineScope *scope.MachineScope) (requeue bool, err error) {
	...
	if err != nil {
		conditions.MarkFalse(machineScope.ProxmoxMachine, infrav1alpha2.VMProvisionedCondition, infrav1alpha2.PoweringOnFailedReason, clusterv1.ConditionSeverityInfo, err.Error())
		return false, err
	}
